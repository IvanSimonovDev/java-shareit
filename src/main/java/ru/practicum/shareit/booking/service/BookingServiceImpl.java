...
public class BookingServiceImpl implements BookingService {
    ...
    public Booking createBooking(Booking booking, long userId) {
        ...
        Long resultId = bookingsRepository.save(booking).getId();
        return bookingsRepository.findById(resultId).get();
    }
    ...
    public Booking permitOrRejectBooking(long bookingId, boolean approve, long userId) {
        ...
        Booking bookingFromStorage = bookingsRepository.findById(bookingId).get();
        ...
        return bookingsRepository.save(bookingFromStorage);
    }
    ...
    private List<Booking> filterAndSortBookings(String bookingSortingProperty,
        ...
        Iterable<Booking> preResult = bookingsRepository.findAll(finalBooleanExpression, sort);
